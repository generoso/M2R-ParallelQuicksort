...
This plot is not so clear, so I try to play with R to get something
more interesting, with means, confidence intervals, lines and legend.

#+begin_src R :results output graphics :file data/jklaptop_2014-10-25/measurements_21:13_1.png :exports both :width 600 :height 400 
library("data.table")
library("ggplot2")
...
#+RESULTS:
[[file:data/jklaptop_2014-10-25/measurements_21:13_1.png]]
...
* TODO Todo [1/3]
- [X] redo R plot with lines, confidence intervals, legend
- [ ] more experiments between 100000 and 1000000
- [ ] plot labels 
